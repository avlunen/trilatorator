...
SOURCES = \
	__init__.py \
	trilatorator.py trilatorator_dialog.py

PLUGINNAME = trilatorator

PY_FILES = \
	__init__.py \
	trilatorator.py trilatorator_dialog.py

UI_FILES = trilatorator_dialog_base.ui
...
QGISDIR=/home/avl/.local/share/QGIS/QGIS3/profiles/default/python/plugins/
